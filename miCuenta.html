            ...
            <nav class="navbar navbar-dark bg-dark">
                ...
                <div class="row col-3 offset-1">
                    <a class="navbar-brand" href="#">
                        <img src="imagenes/icon/icono.png" width="33" style="transform: scale(2.0); margin-right: 25px;"
                            class="d-inline-block align-top" alt="">
                        <b style="font-family: 'Raleway', sans-serif;">Phone Swap</b>
                    </a>
                </div>
                <!-- Barra de busqueda -->
                <div class="row col-3 offset-1">
                        ...
                        <div class="col-md-8 align-self-center"> 
                            ...
                            <form action="update.php" method="post">
                                ...
                                <label>
                                  ...
                                  <input placeholder="phone number" type="tel" id="tlf" name="tlf">
                                  <button class="editar">Editar</button>
                                </label>
                                <label>
                                ...
                                <br>
                                <button id="button-finalizar">Finalizar</button>
                              </form>
